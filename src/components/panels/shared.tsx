  ...
  return (
    <div className="flex gap-1.5 items-center">
      <div className="w-3.5 h-3.5 shrink-0 flex items-center justify-center">
        <svg viewBox="0 0 692 528" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Newly" role="img" className="w-[10px] h-[7.63px]">
...
export function FigmaRole() {
  return (
    <div className="flex gap-1.5 items-center">
      <div className="w-3.5 h-3.5 shrink-0 flex items-center justify-center">
        <svg viewBox="0 0 125 180" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Figma" role="img" className="w-[6.94px] h-[10px]">
...
export function TextQLRole() {
  return (
    <div className="flex gap-1.5 items-center">
      <div className="w-3.5 h-3.5 shrink-0 flex items-center justify-center">
        <TextQLMark className="w-[10px] h-[7.15px]" ariaLabel="TextQL" />
      </div>
